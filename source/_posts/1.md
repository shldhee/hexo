...
class ContactCreator extends React.Component {
  ...
  handleClick() {
    this.props.onInsert(this.state.name, this.state.phone); // 부모 컴포넌트 <ContactCreator onInsert={this._insertContact.bind(this)} /> 메서드 실행
    console.log(this.state.name); // input value
